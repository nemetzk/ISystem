...
#define DATA_64                 ((uint64_t)0Xffffffffffffffff) //0x1234567812345678)
...
static uint32_t num = 123;

typedef struct flashPrivateth
{
	uint32_t FirstPage;
	uint32_t NbOfPages;
	uint32_t BankNumber;
...
#define NUM_OF_DATAS_IN_STORAGE_ARRAY 128
...
void Flash_Write (struct flashMemoryth *FlashMem);
